...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, newProduct, parsedNewProduct, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        parsedNewProduct = JSON.parse(JSON.stringify(newProduct));
                        conn.release();
                        return [2 /*return*/, newProduct];
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not add new product " + p.name + " with ID " + p.id + ". Error: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not GET products with error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not GET products by " + category + " for error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find product " + id + " with error: " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, delProduct, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
