...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.create = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, newOrder, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [o.userId, "open"])];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not add new order for user ID " + o.userId + " for Error: " + err_1);
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, order, err_2, sql, conn, result, orderProduct, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 7:
                        err_3 = _a.sent();
                        throw new Error("Could not add order with ID " + orderId + ". Error: " + err_3);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not find order " + id + ". Error: " + err_5);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not delete order ID " + id + ". Error: " + err_6);
                    case 4: return [2 /*return*/];
                }
            });
        });
